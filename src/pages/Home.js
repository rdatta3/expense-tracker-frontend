          ...
          <div className="container">
            <div className="row pt-5">
              <div className="col-12 col-lg-5 ms-auto">
                <div className="mb-5">
                  <h1 className="display-4 fw-bold mb-5">EXPENSE TRACKER</h1>
                  <h2 >
                     Keep Track of Your Income & Expenses
                  </h2>
                  
                  <p className="lead text-muted mb-5">
                    <li>View all your income and expenses flow from your team in one
                    dashboard</li>
                    <li>Have a look at how much you spend and save</li>
                  </p>
                  
                  <h3>Login or Register to begin ...</h3>
