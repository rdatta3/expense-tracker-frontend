...
{appErr}{serverErr}
    ...
    <section class="py-6">
      <div class="container">
        {/* Grpah */}
        <GraphDtata income={accountDetails?.incomeStats[0]?.totalIncome} expense={accountDetails?.expenseStats[0]?.totalExp}/>
        <div
          style={{
            display: "flex",
        ...
        <div class="row">
          <div class="col-12 col-md-6 mb-6">
            <div class="p-8 border rounded-2">
              ...
              <h1 class="mb-4">{currencyFormatter('INR',accountDetails?.expenseStats[0]?.totalExp)}</h1> 
              <p class="mb-0">
                <span>Number of Transactions</span>
                <span class="text-danger ms-1">
                   <span>{accountDetails?.expenseStats[0]?.totalRecords}</span> 
                </span>
              </p>
          ...
          <div class="col-12 col-md-6 mb-6">
            <div class="p-8 border rounded-2">
              <div class="d-flex mb-6 align-items-start justify-content-between">
               ...
               <h1 class="mb-4">{currencyFormatter('INR',accountDetails?.incomeStats[0]?.totalIncome)}</h1> 

              <p class="mb-0">
                <span>Number of Transactions</span>
                <span class="text-danger ms-1">
                   <span>{accountDetails?.incomeStats[0]?.totalRecords}</span> 
                </span>
              </p>
